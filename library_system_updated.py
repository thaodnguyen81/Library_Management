...
8. Exit""")
    ...
    if   choice == "1": show_books(data)
    elif choice == "2": show_members(data)
    elif choice == "3": add_book(data)
    elif choice == "4": add_member(data)
    elif choice == "5": borrow(data)
